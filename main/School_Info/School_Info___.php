    ...
    <div class="container" id="main">
        <div class="row">
         ...
         <?php
            ...
            $x = 0;
            $c =  sizeof($home) ;
        echo "<table class='mytable table table-condensed table-responsive table-hover'><thead><tr><th>Sr.No</th><th>Transfer Certificate(<i style='color:#fc3;'>TC</i>)</th><th>Download</th><th>View Online</th></tr></thead>";
            for($j = 1; $j < $c; $j++){
                $d = $j + 1;
