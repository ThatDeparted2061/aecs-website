    ...
    <div class="container" id="main">
        <div class="row">
            <div class="jumbotron col-sm-12">   
                <h2 id="heading">School Information</h2>
            </div>
        </div>
         <?php
            /**/
            ...
            $x = 0;
            $c =  sizeof($home) ;
        echo "<table class='mytable table table-condensed table-responsive table-hover'><thead><tr><th>Sr.No</th><th>Documents(<i style='color:#fc3;'>School</i>)</th><th>Download</th><th>View Online</th></tr></thead>";
            for($j = 1; $j < $c; $j++){
                $d = $j + 1;
                  $path_parts = pathinfo($home[$j]);
                    $add =  $path_parts['filename'].'.'.$path_parts['extension'];
                  $address = 'store/' . $add;
